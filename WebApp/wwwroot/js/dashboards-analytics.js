...
function updateButtonText(totalg) {
    // Get the button element
    const button = document.getElementById('growthReportId');
       growthChart(totalg);

    //var totalg = $('#totalGrievances').val();
    // Update the button text with the selected year
  //  button.innerText = element.innerText;
    //$('#companyGrowth').text("Grievances");
    //if (element.innerText === '2021') {
    //    growthChart(totalg);
    //} else if (element.innerText === '2022') {
    //    growthChart(totalg);
    //} else {
    //    growthChart(totalg);
    //}
