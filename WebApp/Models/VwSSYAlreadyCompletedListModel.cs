...
[ApiMetadata("ssyalreadycompleted/admin/ProjectList")]

public class VwSSYAlreadyCompletedListModel : IModel
{
    ...
    public string PlaceOrBeneficiaryId { get; set; } // string
    public string PlaceOrBeneficiaryName { get; set; } // string
