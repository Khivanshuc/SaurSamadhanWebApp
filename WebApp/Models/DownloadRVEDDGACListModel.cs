...
{
    [ApiMetadata("RVEDDGmonitoringalreadycompleted/admin/RVEDDGDownloadProjectList")]
    public class DownloadRVEDDGACListModel : IModel
    {
        ...
        public string ImageWithPanelAndControlRoom { get; set; }
        public string ImageWithPDN { get; set; }
        public string ImageWithFunctionality { get; set; }
        public string ImageWithMeterReading { get; set; }
        public string ImageWithMangpatra { get; set; }
